...
public class CreateJack : MonoBehaviour {

    [SerializeField]
    GameObject jackPieces;
    ...
    void Start()
    {
        CreatePieces(7.5f, -3.5f);
        jacktext.text = "×" + jackPieceNum.ToString();
    }
    ...
    void Update()
    {
        ...
        if (jackPieceNum != 0)
        {
            if (Input.GetMouseButtonDown(0))
            {
                ...
                {
                    if (hit.collider.gameObject.name == "Setjack(Clone)")
    ...
    {
        GameObject obj = Instantiate(jackPieces);
